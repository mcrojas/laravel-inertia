                        ...
                        <div class="md:col-span-2 mt-5 md:mt-0">
                            <div class="px-4 sm:px-0">
                                <form @submit.prevent="submit">
                                    ...
                                    <button class="bg-blue-500 hover:bg-blue-700 rounded-md text-white font-bold py-2 px-4">
                                        Editar
                                    </button>
                                </form>
                                <hr class="my-6">
                                <a href="#" @click.prevent="destroy" class="bg-blue-500 hover:bg-blue-700 rounded-md text-white font-bold py-2 px-4">Eliminar nota</a>
                            </div>
                        </div>
                    </div>
                </div>
